...
def connect_to_db(flask_app, db_uri=os.environ.get('DATABASE_URL') or 'postgresql:///recipes', echo=True):
    print("db_uri on model.py:", os.environ.get('DATABASE_URL') or 'postgresql:///recipes')
