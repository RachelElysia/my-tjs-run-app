...
function ResourcesContainer(props) {
  ...
  (function selfCall() {
    ...
    resources = resourcesData.data.map((resource) => (
      ...
      <Row className="border-top">
        ...
        <Col className="col-5"><Link href={resource.resource_url}><a>{resource.resource_url}</a></Link></Col>
      </Row>
      </Fade>
    ));
  })();
  ...
  return (
    ...
    <Row className="w-100 h-75 pt-5">
      ...
      <ul>
        <li><strong>APIs:</strong> Trader Joe's Recipes API, Twilio API, Google Maps API</li>
        <li><strong>Languages</strong>: Python, JavaScript, JSX, HTML, CSS, SQL</li>
        <li><strong>Frameworks & Libraries</strong>: Flask, React.js, Next.js, Bootstrap, Werkzeug</li>
        <li><strong>Database & Industry Tools</strong>: PostgreSQL, Git, GitHubm VS Code, SQLAlchemy, Next.js, Photoshop</li>
          </ul>
      </Col>      
      <Col className="col-12 p-3 bg-light">
            <Row>
              <Col className="d-none d-md-block col-2"><h3>Topic</h3></Col>
              <Col className="col-5 col-md-2"><h3>Description</h3></Col>
              <Col className="d-none d-md-block col-3"><h3>Use</h3></Col>
              <Col className="col-5"><h3>Link</h3></Col>
      </Row>
            {resources}
      </Col>
      </Row>
